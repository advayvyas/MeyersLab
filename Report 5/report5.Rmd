...
```
Now, I realize that I should have checked for differences between states before trying this out and having it fail spectacularly. Well, looks like Texas and maybe North Carolina are special cases that need to be dealt with seperately.
```{r}
...
I'm just reading through [https://arxiv.org/pdf/0806.3286](this paper) and taking notes to better understand what BART actually is.

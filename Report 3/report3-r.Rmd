...
### Predictions
Comparing to the GAM graph, about 10% more of the predictions are within the 95% confidence interval, which I think is a good sign for this route of modeling/training/fitting.
```{r}
...
### Feature importance
Looks like it ignores two of the variables??? Interesting choice but okay.
```{r, fig.width= 6}
...
### Predictions
Yikes, all over the place fr. Not looking good for LASSO.
```{r, fig.width = 6}

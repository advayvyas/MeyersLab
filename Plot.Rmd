...
In the graph below, I think that the more unique hospitals a city has, the more negative the slope from 2022 Q4 to 2023 Q1 is (how fast the patient count goes down is directly related to the amount of hospitals). However, probably would need to check proportion of hospitals to population (hospitals per capita per city maybe?).

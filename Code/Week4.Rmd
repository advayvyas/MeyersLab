...
```
Aha! Without Austin, the correlation vanishes and is back to wishy-washy stuff. I definitely don't see a trend here, for what it's worth.
```{r, fig.height = 3, fig.width = 7, message=FALSE}
...
imma make a table of the pre and post and then the delta and then talk about major changes
